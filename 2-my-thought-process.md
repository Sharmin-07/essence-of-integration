Why I did this
(This is a personal account and reflects my own experience — read only if you’re interested.)
...
I understood that integrating essentially means adding up infinitely small numbers, and I wondered that if we had not approximated the strip to be a rectangle and had included it in the integration as it is, it should also amount to some value. When I confronted my teacher about this, he said that it was because the approximation removes the area of the strip which is of the order of (dr)², and since (dr)² vanishes faster than dr, we neglect it. That sounded like a sentence straight out of a textbook, and I've never liked textbook explanations. I prefer to rebuild ideas from intuition and logic until they make sense.
